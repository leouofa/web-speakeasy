...
function UserData({ username, roomHash, sharePublicAddress, handleExit, handlePublicToggle }: Props){
  ...
  return (
    <div className="flex align-middle flex-col md:flex-row">
      ...
      <div className="self-center ml-auto mt-5 md:mt-0">
        <a href=""
           className="block lg:inline mr-4 mb-3 lg:mb-0 bg-transparent text-white
          ...
          { sharePublicAddress ? 'Share Address Public' : "Don't Share Public Address" }
        </a>
        <a href=""
