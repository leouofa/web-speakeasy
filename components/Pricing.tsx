        ...
        <div className="sm:flex sm:flex-col sm:align-center">
          ...
          <div className="relative self-center mt-6 bg-zinc-900 rounded-lg p-0.5 flex sm:mt-8 border border-zinc-800">
            <button
              ...
              } rounded-md m-1 py-2 text-sm font-medium whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-zinc-500 focus:ring-opacity-50 focus:z-10 sm:w-auto sm:px-8`}
            >
              Monthly billing
            </button>
            <button
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  {
                    'border border-zinc-500': subscription
